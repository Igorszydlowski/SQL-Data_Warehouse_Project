/*
==================================
STORED PROCEDURE SILVER
==================================
THIS SCRIPT PERFORMS ETL PROCESS TO POPULATE THE SILVER SCHEMA FROM BRONZE TABLES.
*/
...
begin 
	...
	sls_ord_num,
		...
		case when 
		sls_ship_st <= 0 or len(sls_ship_st) !=8 then NULL
		else cast(cast(sls_ship_st as VARCHAR) as DATE)
		end as sls_ship_st,
		case when 
